...
// export
if (typeof module !== 'undefined') module.exports = Showdown;// Generated by CoffeeScript 1.3.2
(function() {
  var CNEditor, initPage,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

  initPage = function() {
    var cb, editor, editorIframe$;
    $("body").html('<div id="editorContent" class="table-ly-ctnt"><iframe id="editorIframe"><html id="__ed-iframe-html"><head><link rel="stylesheet" href="editor.css"></head><body id="__ed-iframe-body" contenteditable="true"></body></html></iframe></div>');
    editorIframe$ = $("iframe");
    $("iframe").on("onHistoryChanged", function() {
      return console.log("history updated");
    });
    cb = function() {
  ...
  CNEditor = (function() {
    ...
    */
    ...
    function CNEditor(iframeTarget, callBack) {
      ...
      iframe$.on('load', function() {
        ...
        editor_css$ = editor_head$.html('<link href="editor.css" \
                                               rel="stylesheet">');
    ...
    */
    ...
    CNEditor.prototype._normalize = function(range) {
      var elt, endContainer, next, prev, startContainer, _ref, _ref1;
      ...
      } else if ((_ref1 = !endContainer.parentNode) === "SPAN" || _ref1 === "IMG" || _ref1 === "A") {
    ...
    */
    ...
    CNEditor.prototype._keyPressListener = function(e) {
      var i, keyStrokesCode, metaKeyStrokesCode, num, range, sel, shortcut, _i, _ref;
      ...
      if (this.currentSel === null) {
        ...
        if ((endContainer.id != null) && endContainer.id.substr(0, 5) === 'CNID_') {
          ...
          if (parentEndContainer.nodeType === Node.TEXT_NODE) {
            ...
            rangeIsEndLine = nextSibling === null || (initialEndOffset === parentEndContainer.textContent.length && nextSibling.nodeName === 'BR');
          }
    ...
    */
    ...
    CNEditor.prototype._moveLinesDown = function() {
      ...
      if (lineNext !== null) {
        ...
        savedSel = rangy.saveSelection(rangy.dom.getIframeWindow(this.editorIframe));
    ...
    CNEditor.prototype._moveLinesUp = function() {
      var cloneLine, line, lineEnd, lineNext, linePrev, lineStart, myRange, numOfUntab, savedSel, secondL, sel, _results, _results1;
      this._findLines();
      sel = this.currentSel;
      lineStart = sel.startLine;
      lineEnd = sel.endLine;
    ...
    */
    ...
    CNEditor.prototype._addHistory = function() {
      ...
      savedScroll = {
        xcoord: this.editorIframe.contentWindow.scrollX,
        ycoord: this.editorIframe.contentWindow.scrollY
      };
    ...
    CNEditor.prototype.unDo = function() {
      ...
      if (this.undoPossible()) {
        ...
        this.editorIframe.contentWindow.scrollTo(xcoord, ycoord);
    ...
    CNEditor.prototype.reDo = function() {
      ...
      if (this.redoPossible()) {
        ...
        return this.editorIframe.contentWindow.scrollTo(xcoord, ycoord);
      }
    };
